		...
		<table>
				...
				<tr>
					...
					<s:if test="photoExists()">
						<img src="<s:url value="%{logoPhotoPaht}"/>" height="25px" width="50px">
					</s:if>	<!-- 调查标题 -->
						<s:property value="title" />
					</td>
					<td class="tdSHeaderR">
						<s:a href="survey-toAddLogoPage?sid=%{#sId}">增加</s:a>Logo&nbsp;
						<s:a action="survey-editSurvey?sid=%{#sId}">编辑调查&nbsp;</s:a>
						<s:a href="page-addPage?sid=%{#sId}">增加页&nbsp;</s:a>
					</td>
				</tr>
				<tr>
											...
											<td>
												<table>
													<tr>
														...
														<td class="tdPHeaderR">
															<s:a href="page-editPage?sid=%{#sId}&pid=%{#pId}">编辑页标题</s:a>&nbsp;
															移动/复制页&nbsp;
															<s:a href="question-selectOneQuestionType?pid=%{#pId}&sid=%{#sId}">增加问题</s:a>&nbsp;
															<s:a href="page-delPage?sid=%{#sId}&pid=%{#pId}">删除页</s:a>&nbsp;
														</td>
													</tr>
												</table>
											</td>
																	...
																	<td>
																		<table>
																			...
																			<tr>
																				...
																				<td class="tdQHeaderR">
																					<s:a href="question-editQuestion?qid=%{#qId}&sid=%{#sId}&pid=%{#pId}">编辑问题</s:a>&nbsp;
																					<s:a href="question-deleteQuestion?sid=%{#sId}&qid=%{#qId}">删除问题</s:a>&nbsp;
																				</td>
																			</tr>
																			<tr>
